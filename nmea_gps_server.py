...
# Tested on MSSQL, but should support PostgreSQL or SQLlite depending on app needs
# http://docs.sqlalchemy.org/en/latest/dialects/postgresql.html
dbdriver = 'mssql+pymssql'
dbuser = ''
dbpass = ''
dbserver = ''
dbport = ''
...
def read_nmea(source, port, gpgga):
    ...
    for msg in gpgga:
        ...
        msgtimeUTC_t = (
            msgtimeUTC - datetime.datetime(1970, 1, 1)).total_seconds()
        msgtype = '$GPGGA'
